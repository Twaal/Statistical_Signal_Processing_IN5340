...
\vspace{0.5em}
\small
Simulation in notebook: $N=5000$ samples.
\end{frame}
...
\small
\begin{align*}
\text{rp1: }\; v[n] &= \big(\mathrm{rand}-0.5\big)\,\underbrace{b\sin(\pi n/N)}_{\text{time-varying scale}} + \underbrace{a n}_{\text{time-varying mean}},\\
