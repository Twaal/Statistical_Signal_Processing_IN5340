<#
.SYNOPSIS
  Scaffold a new IN5340/IN9340 Beamer presentation from a template.

.EXAMPLE
  .\scripts\new_in5340_presentation.ps1 -ProjectDir .\Project_2 -Output presentation_p2.tex -Title "IN5340 Project II" -ShortTitle "IN5340 P2" -Author "Theodor Wålberg" -Compile
...
$templatePath = Join-Path $PSScriptRoot "in5340_beamer_template.tex"
